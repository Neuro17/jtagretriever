...
// search count photos after maxIteration iterations for each tag, time and location checked
// BAD
...
//	each photo have two of the tags taken from the tags and is geolocalized
